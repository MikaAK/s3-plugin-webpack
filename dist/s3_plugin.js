...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'http', 'https', 's3', 'fs', 'path', 'progress', 'cdnizer', 'lodash'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('http'), require('https'), require('s3'), require('fs'), require('path'), require('progress'), require('cdnizer'), require('lodash'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.http, global.https, global.s3, global.fs, global.path, global.progress, global.cdnizer, global.lodash);
    global.s3_plugin = mod.exports;
  }
})(this, function (exports, _http, _https, _s, _fs, _path2, _progress, _cdnizer, _lodash) {
  ...
  var S3Plugin = (function () {
    ...
    _createClass(S3Plugin, [{
      ...
      value: function uploadFile(fileName, file) {
        var upload,
            s3Params = _lodash2.default.merge({
          Key: this.options.basePath + fileName
        }, DEFAULT_UPLOAD_OPTIONS, this.uploadOptions);
